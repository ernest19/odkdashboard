...
def dashboard(request):
	...
	return render(request, 'real/dashboard.html',locals())
...
def landingPage(request):
	...
	for aa in quest:
		print(aa.title)
	return render(request, 'real/index.html',locals())
...
def getDistricts(request,region):
	...
	data = {
		'alldistricts':render_to_string('real/districts.html',locals())
	}
	...
	if otherFields:
		...
		if otherFields[2] != "Empty":
			if otherFields[2] == 'Sex':
				...
				data = {
						'pre':render_to_string('real/newpre.html',locals()),
						'questionaire':render_to_string('real/newques.html',locals()),
						'questionaire2':render_to_string('real/newques2.html',locals()),
						'questionaire4':render_to_string('real/newques4.html',locals()),
						'post':render_to_string('real/newpost.html',locals())
						}
...
# ````````````````enough_sensitization_elevy   new change
				...
				data = {
						'pre':render_to_string('real/newpreAge.html',locals()),
						'questionaire':render_to_string('real/newquesAge.html',locals()),
						'questionaire2':render_to_string('real/newquesAge2.html',locals()),
						'questionaire4':render_to_string('real/newquesAge4.html',locals()),
						'post':render_to_string('real/newpostAge.html',locals())
						}
			if otherFields[2] == 'Education': 
				...
				data = {
						'pre':render_to_string('real/newpreEducation.html',locals()),
						'questionaire':render_to_string('real/newquesEducation.html',locals()),
						'questionaire2':render_to_string('real/newquesEducation2.html',locals()),
						'questionaire4':render_to_string('real/newquesEducation4.html',locals()),
						'post':render_to_string('real/newpostEducation.html',locals())
						}
