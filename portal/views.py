		...
		if otherFields[2] != "Empty":
			if otherFields[2] == 'Sex':
				...
				data = {
						...
						'questionaire4':render_to_string('newques4.html',locals()),
...
# ````````````````enough_sensitization_elevy   new change
				...
				data = {
						...
						'questionaire4':render_to_string('newquesAge4.html',locals()),
			...
			if otherFields[2] == 'Education': 
				...
				data = {
						...
						'questionaire4':render_to_string('newquesEducation4.html',locals()),
